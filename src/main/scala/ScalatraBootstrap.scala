...
class ScalatraBootstrap extends LifeCycle {
  ...
  ConfiguredBoard("sveetch", "http://sveetch.net/tribune/remote/xml/", "last_id", Slip.Raw, "http://sveetch.net/tribune/post/xml/", "content", "http://sveetch.net/accounts/login/", "", "username", "password", "#ededdb", "sveetch")
...
//  ConfiguredBoard("olo", "http://board.olivierl.org/remote.xml","",Slip.Raw,"http://board.olivierl.org/add.php","message","","","","")
  ConfiguredBoard("moules", "http://moules.org/board/backend/xml", "last_id", Slip.Raw, "http://moules.org/board/add.php", "message", "http://moules.org/board", "", "name", "pass", "#ffe3c9", "")
